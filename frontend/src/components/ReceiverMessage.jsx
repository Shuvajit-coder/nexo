...
function ReceiverMessage({message}) {
    ...
    useEffect(()=>{
       scroll.current.scrollIntoView({behavior:"smooth"})
        },[message.messages,message.image])
  return (
    <div ref={scroll} className='w-fit max-w-[60%] bg-[#1998ff] rounded-t-2xl rounded-bl-0 rounded-br-2xl px-[10px] py-[10px] relative left-0 right-0 flex flex-col gap-[10px]'>
        {message.image && 
